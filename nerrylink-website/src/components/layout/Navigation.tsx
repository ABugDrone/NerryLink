    ...
    <nav aria-label="Main navigation">
      ...
      {open && (
        <div
          ...
          style={{
            background: isLight ? 'rgb(248,245,255)' : 'rgb(5,5,15)',
            backdropFilter: 'none',
            isolation: 'isolate',
          }}
        >
          ...
          <div className={`px-6 py-6 border-t flex flex-col gap-3 ${isLight ? 'border-purple-200/50' : 'border-white/10'}`}>
            ...
            <div className={`pt-3 border-t ${isLight ? 'border-purple-200/40' : 'border-white/10'}`}>
              <p className={`text-xs font-semibold uppercase tracking-widest mb-3 ${isLight ? 'text-[#6B21A8]/60' : 'text-white/30'}`}>Follow Us</p>
              <div className="flex items-center gap-3">

                {/* Facebook */}
                <a
                  href="https://web.facebook.com/profile.php?id=100067730592515"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="NerryLink on Facebook"
                ...
                {/* WhatsApp */}
                <a
                  href="https://wa.me/2348166490440"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.google.com/maps/search/?api=1&query=NERRYLINK'S+GLOBAL+SERVICES"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* Phone / Call */}
                <a
                  href="tel:+2348166490440"
                  aria-label="Call NerryLink"
                  className={`flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-150 ${
                    isLight
